...
3. **마커는 반드시 원본 그대로 유지!**
   - 입력에 ###DIVIDER1###이면 → 출력도 ###DIVIDER1###
   - 입력에 ###DIVIDER2###이면 → 출력도 ###DIVIDER2###
   - 입력에 ###IMG1###이면 → 출력도 ###IMG1###
   - 입력에 ###IMG2###이면 → 출력도 ###IMG2###
4. 마커의 위치 변경 금지 (독립된 줄 유지)
...
⚠️ 주의: 마커(###DIVIDER1###, ###DIVIDER2###, ###IMG1###, ###IMG2###)를 절대 바꾸거나 제거하지 말 것!
