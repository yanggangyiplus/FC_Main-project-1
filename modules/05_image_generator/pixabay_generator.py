...
from config.settings import PIXABAY_API_KEY, IMAGES_DIR
...
class PixabayGenerator:
    ...
    def __init__(self, category: str = "", image_type: str = "photo", per_page: int = 5):
        """
        Args:
        ...
        logger.info(f"PixabayGenerator 초기화 (카테고리: {category or '없음'}, 타입: {image_type})")
