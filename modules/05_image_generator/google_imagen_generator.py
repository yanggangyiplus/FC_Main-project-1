...
class GoogleImagenGenerator:
    ...
    # Imagen 모델 버전 (사용 가능한 모델)
    # - imagen-4.0-generate-001: 고품질 (기본)
    ...
    def __init__(self, category: str = "", aspect_ratio: str = "16:9", use_llm: bool = True):
        """
        Args:
        ...
        try:
            ...
            response = self.client.models.generate_images(
                ...
                config=types.GenerateImagesConfig(
                    ...
                    safety_filter_level="BLOCK_LOW_AND_ABOVE",  # 안전 필터 (지원되는 값)
                    person_generation="DONT_ALLOW"  # 사람 생성 비허용 (저작권 안전)
                )
            )
