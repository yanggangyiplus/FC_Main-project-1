...
⚠️ 중요: h2 태그는 반드시 "서론", "본론", "결론"이라는 텍스트를 정확히 사용해야 합니다!
...
<body>
    ...
    <img src="PLACEHOLDER" alt="영어로 이미지 설명" class="blog-image">
...
1. h2 태그는 반드시 "서론", "본론", "결론" 이 3개의 정확한 텍스트를 사용!
   - <h2>서론</h2> ✅
   - <h2>Introduction</h2> ❌
   - <h2>들어가며</h2> ❌
2. 이미지는 본론에만 배치! (서론, 결론 이미지 금지)
3. img 태그는 반드시 독립된 줄에 배치 (앞뒤 빈 줄)
